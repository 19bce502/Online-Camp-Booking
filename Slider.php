                    ...
                    <div class="col-12">
                        <div class="block table-block mb-4">
                            <div class="table-responsive">
                                ...
                                <?php
                                    include 'conn.php';
                                    $res=mysql_query("select * from slider ORDER by id DESC");
                                ...
                                ?>
                                    <tr>
                                        <td><?php echo $id ?></td>
                                        <td class="price"><img src="../project/images/slider/<?php echo $row[1] ?>" hight="50" width="50"></td>
                                        
                                        <td><a href="delete_slider_process.php?id=<?php echo $row[0] ?>"><button>Delete</button></a></td>
                                    </tr>
                                <?php
                                        $id++;
                                        $row=mysql_fetch_row($res);
