                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="block form-block mb-4">
                            <form action="edit_pkg_processs.php" method="POST" enctype="multipart/form-data">
                                   <?php
                                $id=$_GET['id'];
                            ...
                            <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Days" type="text" name="id" value="<?php echo $id; ?>"required="" Disabled>
                                ...
                                $id=$_GET['id'];
                                include "conn.php";
                                $res=mysql_query("select * from pkg where id=$id");
                            ...
                            ?>
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" type="text" name="name" value="<?php echo $row1[2]; ?>">
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" type="text" name="cost" value="<?php echo $row1[3]; ?>">
