                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="block form-block mb-4">
                            <form action="Add_pkg_process.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="From Source To Destination" type="text" name="name" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Cost per Person" type="text" name="cost" required="">
                                        </div>
                                    </div>
                                </div>
