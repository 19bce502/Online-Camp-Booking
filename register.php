      ...
      <section class="contact-page gallery-masonry sec-padding">
         <div class="zt-container">
            <div class="sec-title text-center sec-title-padding">
               <h2>REGISTER</h2>
               <span class="tagline">For booking a camp one should reister first. All the information specified here must be correct and valid.</span>
            </div>
            
            <form class="form contact-form" action="insert.php" method="POST" enctype="multipart/form-data">
               <div class="row">
                  ...
                  <div class="col-md-offset-4 col-md-4 col-sm-6 col-xs-12">
                     ...
                     <div class="col-md-offset-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                           <div class="input-icon left">
                              <input type="password" name="Password" class="zt-control" placeholder="Your Password*" required>
                              <div class="input-addon"><span class="fa fa-user"></span></div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-md-offset-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                           <div class="input-icon left">
                              <input type="number" name="age" class="zt-control" placeholder=" Age **" required>
                              <div class="input-addon"><span class="fa fa-user"></span></div>
                           </div>
                        </div>
                     </div>
